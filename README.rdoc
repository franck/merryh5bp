...
- replacing the content of rails default layout application.html.erb by the content of index.html from html5-boilerplate. Adding several rails stuffs (csrf_meta_tag, yield in the main div, yield(:head) in the <head>, yield(:foot) at the bottom). Replacing the css and js folder name of H5BP by the Rails naming style : stylesheets/ and javascripts/
- copying H5BP css and js assets in the public directory (keeping application.js instead of script.js). 
